    ...
    <div className="flex flex-col gap-6 w-full animate-in fade-in duration-200">
      ...
      <div className="bg-white border border-slate-200 rounded-xl p-4 shadow-xs flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-4">
        <div className="flex items-center gap-3">
          <div className={`w-9 h-9 rounded-lg flex items-center justify-center shrink-0 ${isPolling ? 'bg-emerald-100 text-emerald-800' : 'bg-slate-100 text-slate-700'}`}>
            <Radio size={19} className={isPolling ? 'animate-pulse text-emerald-600' : ''} />
          </div>
          <div>
            <div className="flex items-center gap-2">
              <h2 className="text-sm font-bold text-slate-900">Live Match Assistant</h2>
              {isPolling && (
        ...
        <div className="flex items-center gap-2">
          <div className="relative flex-1 sm:w-60">
            <input
              ...
              className="w-full pl-8 pr-3 py-1.5 bg-slate-50 border border-slate-300 rounded-md text-xs text-slate-900 focus:bg-white focus:outline-none focus:border-slate-500 transition font-medium"
            />
        ...
        <div className="lg:col-span-7 flex flex-col items-center gap-3">
          <div className="flex items-stretch gap-2 md:gap-3 justify-center w-full max-w-[560px]">
            ...
            <div className="flex flex-col flex-1 min-w-0 max-w-[500px]">
              ...
              {/* Chessboard */}
              <div className="aspect-square w-full rounded-none overflow-hidden border-x border-slate-300 shadow-sm relative">
                <Chessboard
                  options={{
                    position: currentFen,
          ...
          <div className="flex items-center justify-between w-full max-w-[560px] bg-white border border-slate-200 rounded-lg px-3 py-2 text-xs">
            <button
              ...
              <div className="flex flex-col gap-3">
                <div className="flex items-center justify-between p-3 rounded-lg bg-emerald-50 border border-emerald-200">
                  ...
                  <div className="text-right">
                    <span className="text-[10px] text-emerald-700 block uppercase font-medium">
                      Position Eval
                    </span>
          ...
          {activeGame && (
            <div className="bg-white border border-slate-200 rounded-xl p-4 shadow-xs flex flex-col gap-3">
              <div className="flex items-center justify-between text-xs">
                <span className="font-semibold text-slate-900">Game Information</span>
                <a
                  href={activeGame.url}
                  target="_blank"
                  rel="noreferrer"
              ...
              {activeGame.pgn && (
                <button
                  ...
                  className="w-full py-2 bg-slate-900 hover:bg-slate-800 text-white rounded-lg text-xs font-semibold transition flex items-center justify-center gap-1.5"
                >
