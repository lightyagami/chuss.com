    ...
    <div className="bg-white border border-slate-200 rounded-lg p-4 shadow-xs flex flex-col gap-4">
      <div className="flex items-center justify-between border-b border-slate-100 pb-2">
        ...
        <span className="text-xs font-mono text-slate-500">
          Result: <strong className="text-slate-900">{headers.Result || '*'}</strong>
        </span>
      </div>
      ...
      <div className="grid grid-cols-2 gap-3">
        {}
        <div className="bg-slate-50 border border-slate-200 rounded-md p-3 flex flex-col gap-2">
      ...
      <div className="space-y-1 pt-1 text-xs">
        {statCategories.map((cat) => {
          ...
          return (
            <div
              key={cat.key}
              className="grid grid-cols-[1fr_auto_1fr] items-center px-2 py-1 rounded bg-slate-50/70 hover:bg-slate-100 transition"
            >
              {}
              <span className="font-mono font-semibold text-slate-800 text-left pl-2">
                {whiteCount}
              </span>
              ...
              {}
              <span className="font-mono font-semibold text-slate-800 text-right pr-2">
                {blackCount}
              </span>
            </div>
          );
