    ...
    <header className="sticky top-0 z-40 bg-white/95 dark:bg-black/95 backdrop-blur-md border-b border-slate-200 dark:border-zinc-800 transition-colors">
      <div className="max-w-7xl mx-auto px-3 sm:px-6 h-14 flex items-center justify-between gap-2 sm:gap-3">
        <div className="flex items-center gap-2 sm:gap-3 shrink-0">
          ...
          >
            <div className="w-8 h-8 rounded-lg bg-slate-900 dark:bg-white flex items-center justify-center text-white dark:text-black font-bold text-base shadow-xs shrink-0">
              ♔
            </div>
          ...
          <div className="flex items-center bg-slate-100 dark:bg-zinc-900 p-0.5 rounded-lg border border-slate-200 dark:border-zinc-800 text-xs font-medium overflow-x-auto max-w-[200px] sm:max-w-none scrollbar-none">
            <button
              onClick={() => onSelectMode('review')}
              className={`px-2 sm:px-2.5 py-1 rounded-md transition shrink-0 ${
                mode === 'review'
            ...
            <button
              ...
              className={`flex items-center gap-1 px-2 sm:px-2.5 py-1 rounded-md transition shrink-0 ${
                mode === 'live'
        ...
        <div className="flex items-center gap-1 sm:gap-1.5 shrink-0 overflow-x-auto scrollbar-none">
            ...
            <>
              {onOpenTacticsQuiz && (
                <button
                  ...
                  className="flex items-center gap-1 px-2 py-1.5 rounded-md bg-amber-50 dark:bg-zinc-900 hover:bg-amber-100 dark:hover:bg-zinc-800 border border-amber-200 dark:border-zinc-800 text-xs font-semibold text-amber-700 dark:text-amber-400 transition shrink-0"
              ...
              {(onExportPgn || onExportImage || onOpenVideoModal) && (
                <div className="flex items-center bg-slate-100 dark:bg-zinc-900 p-0.5 rounded-lg border border-slate-200 dark:border-zinc-800 text-xs font-medium shrink-0">
                  {onExportPgn && (
                    <button
                      onClick={onExportPgn}
                      className="flex items-center gap-1 px-1.5 sm:px-2 py-1 rounded-md text-slate-700 dark:text-zinc-300 hover:text-slate-900 dark:hover:text-white transition"
                  ...
                  {onOpenVideoModal && (
                    <button
                      ...
                      className="flex items-center gap-1 px-1.5 sm:px-2 py-1 rounded-md text-indigo-600 dark:text-indigo-400 hover:text-indigo-700 dark:hover:text-indigo-300 transition font-medium"
              ...
              <div className="flex items-center bg-slate-100 dark:bg-zinc-900 p-0.5 rounded-lg border border-slate-200 dark:border-zinc-800 text-xs font-medium shrink-0">
                ...
                <button
                  ...
                  className={`flex items-center gap-1 px-1.5 sm:px-2 py-1 rounded-md transition ${
                    showDualBoard
              ...
              <div className="flex items-center gap-1 sm:gap-1.5 shrink-0">
                <button
                  ...
                  className="flex items-center gap-1 px-2 sm:px-2.5 py-1.5 rounded-md bg-white dark:bg-zinc-950 hover:bg-slate-50 dark:hover:bg-zinc-900 border border-slate-300 dark:border-zinc-800 text-xs font-semibold text-slate-800 dark:text-zinc-200 disabled:opacity-50 transition"
                  title="Run Full Engine Analysis"
                >
                ...
                <button
                  ...
                  className="flex items-center gap-1 px-2.5 sm:px-3 py-1.5 rounded-md bg-slate-900 dark:bg-white hover:bg-slate-800 dark:hover:bg-zinc-100 text-xs font-semibold text-white dark:text-black transition shadow-xs"
                  title="Import PGN or Fetch Live Game"
                >
          ...
          <button
            ...
            className="p-1.5 rounded-md bg-white dark:bg-zinc-950 hover:bg-slate-50 dark:hover:bg-zinc-900 border border-slate-300 dark:border-zinc-800 text-slate-700 dark:text-zinc-200 transition shrink-0"
